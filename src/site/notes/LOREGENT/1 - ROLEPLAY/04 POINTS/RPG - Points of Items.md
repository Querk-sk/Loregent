...
After rolling the dice, all successes are summed. If the number of successes is lower, the item is created with worse attributes or no item is created at all, and the materials are destroyed.
