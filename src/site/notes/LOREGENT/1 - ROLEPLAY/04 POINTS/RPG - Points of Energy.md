---
{"dg-publish":true,"permalink":"/loregent/1-roleplay/04-points/rpg-points-of-energy/","noteIcon":""}
---
...
[[LOREGENT/1 - ROLEPLAY/z RPG variables/variables Points/Points of Energy\|Points of Energy]] serve as a reservoir. After each spell, its energy points are reduced. When the energy points drop to 0, the character will use [[LOREGENT/1 - ROLEPLAY/z RPG variables/variables Points/Points of Health\|Points of Health]] instead of energy points. The cost of spells, for both types of points, is determined by category (see below).

##### Small Useful Spells

**These are**: Lighting a candle, lighting a campfire, cooling beer, healing very small wounds (like a knife cut).

**Consumption**: These spells consume no energy.

##### Common Useful Spells

**These are**: All [[LOREGENT/1 - ROLEPLAY/z RPG variables/variables Dices/useful\|useful]] spells except small and large ones.

**Consumption**: 1 spell consumes 1 energy point.
...
**Spell Consumption by Weapon Type**:
- 1 small weapon type spell consumes 1 energy point    
- 1 medium weapon type spell consumes 2 energy points    
- 1 large weapon type spell consumes 3 energy points    

**Armor Consumption**:
- 1 light armor consumes 1 energy point    
- 1 medium armor consumes 2 energy points    
- 1 heavy weapon consumes 3 energy points

>[!note]
Note When the type of combat spell cannot be determined, the spell consumes 2 energy points.
