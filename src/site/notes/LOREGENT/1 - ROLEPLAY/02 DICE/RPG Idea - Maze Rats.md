...
The tables have 36 results are organized into 6 groups of 6 results each. To randomly pick an item from one of these tables, roll 2D6 separately. The first die points to a group, while the second die points to an item with that group. For example rolling 4 2 on the appearance table means group 4 item 2 : Lanky. Bolded items refer you to another random table where you should roll again.
### TAG and LINK : 
