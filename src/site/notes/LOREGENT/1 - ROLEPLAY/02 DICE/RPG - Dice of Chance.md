...
When the narrator wants to make their game more interesting or is unsure what to do, they can use a random events table. These can provide answers to questions like:

- What is the [[LOREGENT/1 - ROLEPLAY/07 ADDITIONAL CONTENT/RPG - Random Weather\|weather]] like where the characters are?    
- Who did the characters [[LOREGENT/1 - ROLEPLAY/07 ADDITIONAL CONTENT/RPG - Random Encounter\|meet]] while traveling through the forest?    
- What magic is the [[LOREGENT/1 - ROLEPLAY/07 ADDITIONAL CONTENT/RPG - Random conflict\|enemy using]]?    
- And many more

To determine a random event, regular dice (D6) are used, where the number on the dice or dice indicates a specific option in the table. All events or options are organized into groups, with the number of options depending on the number of possibilities. The narrator rolls the dice separately. The first die determines the group (i.e., the column in the table), while the second die determines the item in that group (i.e., the cell in the table).

>[!example] 
A roll of 4 and 2 in the [[LOREGENT/1 - ROLEPLAY/z RPG variables/variables Mechanics/Disabling Characteristic\|disadvantage]] table means "Emotional."

The narrator can use:

- The first die to determine the table (e.g., even number and odd number)    
