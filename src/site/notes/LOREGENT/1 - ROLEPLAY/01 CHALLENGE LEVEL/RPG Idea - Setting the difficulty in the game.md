...
- Divide characters into those that are easy to play and those that are hard to play. (But let's say, hard characters will be more interesting in terms of mechanics.)    
- Voluntary challenges and alternative paths that are harder.    
- Companions who help with a problem.    
- Items that help with a problem, or those that add some challenge.    
- More keys to open doors than necessary. Some ways of obtaining keys are more difficult than others, so the player can choose.    
- Multiple paths to choose from, one easier and one harder.

##### What is the reward for a challenging game?

- Bragging rights?    
- And how to balance the reward. So beginners don't get worse items and stay in easy mode, while hard players get a bigger reward when they pass a hard level.
 
---
### Sources :
- Author : Mark Brown ,  date published : 2024 January 19
	- Title : Super Mario's Invisible Difficulty Settings
	- read : 2024 January 21
	- from : https://youtu.be/gkvyYTSKTQY?si=QQQOambjgbzwoun2
	- Domain : Youtube
